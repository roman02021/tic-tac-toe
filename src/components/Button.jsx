...
const Btn = css`
  ...
  /* ${(props) =>
    props.$isPressing
      ? css`
          box-shadow: inset 0 -2px 0 ${theme.colors.secondaryBorder};
        `
      : css`
  ...
  border-width: ${(props) =>
    props.$borderWidth === 'small'
      ? theme.borders.bottomWidthSmall
      : theme.borders.bottomWidthMedium};

  &:not(:last-child) {
    ${(props) =>
      props.$vertical ? 'margin-bottom: 1.25rem' : 'margin-right: 1rem'};
  }
...
const handleColorType = (color) => {
  switch (color) {
    case 'blue':
      return css`
        background-color: ${theme.colors.primaryCross};
        ...
        @keyframes buttonHoverBlue {
          ...
          50% {
            box-shadow: inset 0 -4px 0 ${theme.colors.primaryCrossBorder};
        ...
        @keyframes buttonPressBlue {
          ...
          100% {
            box-shadow: inset 0 -2px 0 ${theme.colors.primaryCrossBorder};
        ...
        &:active {
          background-color: ${theme.colors.primaryCrossHover};
          animation: buttonPressBlue 0.2s forwards;
        }
      `;
    case 'silver':
      return css`
        ...
        @keyframes buttonHoverSilver {
          ...
          50% {
            box-shadow: inset 0 -6px 0 ${theme.colors.primaryCrossBorder};
            transform: translateY(2px);
          }
          100% {
            box-shadow: inset 0 -8px 0 ${theme.colors.primaryCrossBorder};
        ...
        &:active {
          background-color: ${theme.colors.primaryCrossHover};
          animation: buttonPressSilver 0.2s forwards;
        }
      `;
    default:
      return css`
        background-color: ${theme.colors.primaryCircle};
        ...
        &:active {
          background-color: ${theme.colors.primaryCircleHover};
          animation: buttonPressYellow 0.2s forwards;
        }
      `;
  }
};
